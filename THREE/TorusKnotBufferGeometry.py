...
class TorusKnotGeometry(Geometry):
    def __init__(self,radius=100, tube=40, tubularSegments=64, radialSegments=8, p=2, q=2, heightScale=None ):
        super().__init__()
        ...
        if heightScale is not None:
            print( 'THREE.TorusKnotGeometry: heightScale has been deprecated. Use .scale( x, y, z ) instead.' )
